...
def build_orchestrator_instructions(today_date: str) -> str:
    ...
    return (
        ...
        "SECURITY: get_document/save_document/query_documents REQUIRE business_id and only allow paths under "
        "businesses/{business_id}/<allowed_subcollection>. Always pass business_id from context. "
        "Allowed subcollections: instagram_stats, reports, seo, agent_memory, media, instagram_posts, "
        "youtube_videos, content_calendar, tasks, logs, dry_run_logs, tiktok_posts, linkedin_posts, "
        "media_tracking, marketing_memory. "
        "\n\n"
