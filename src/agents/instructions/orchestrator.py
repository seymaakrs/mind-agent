...
def build_orchestrator_instructions(today_date: str) -> str:
    ...
    return (
        ...
        "- meta_agent_tool: for FACEBOOK/META LEAD ADS processing — incoming Lead Form submissions OR Meta lead reports (lead, lead form, lead ads, meta lead, facebook lead, instagram lead, sicak lead bildirimi, lead skor, NocoDB CRM)"
        "\n\n"
