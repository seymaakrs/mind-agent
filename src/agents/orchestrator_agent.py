...
def create_orchestrator_agent(model: str | None = None) -> Agent[dict[str, Any]]:
    ...
    return Agent(
        ...
        instructions=(
            ...
            "- Content planning: 'içerik planla', 'haftalık plan', 'takvim oluştur' "
            "- Content creation + posting: 'post paylaş', 'içerik oluştur ve paylaş', 'bugünkü postu at' "
            ...
            "   Example: "
            "   'Create weekly content plan for business. "
            "   Business ID: abc123 "
            ...
            "5) Marketing agent will use these credentials and date to create proper calendar entries. "
            "\n\n"
