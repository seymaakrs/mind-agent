...
def create_orchestrator_agent(
    ...
    return Agent(
        ...
        instructions=(
            ...
            "- video_agent_tool: for VIDEO generation AND AUDIO generation (video, klip, animasyon, reel, ses ekleme, muzik ekleme, ses duzenleme) - use when user wants video WITHOUT posting OR wants to add/change audio on existing video "
